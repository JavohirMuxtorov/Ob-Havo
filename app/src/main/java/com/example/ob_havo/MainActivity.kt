...
import com.example.ob_havo.models.WeatherResponse
import com.example.ob_havo.network.WeatherService
import com.example.ob_havo.utils.Constant
    ...
    private fun getLocationWeatherDetails() {
        ...
        if (Constant.isNetworkAvailable(this@MainActivity)) {
            ...
            val listCall: Call<WeatherResponse> = service.getWeather(
                mLatitude, mLongitude, Constant.METRIC_UNIT, Constant.APP_ID
            )
